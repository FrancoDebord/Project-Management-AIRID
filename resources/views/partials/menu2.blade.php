										...
										<ul class="pcoded-submenu">
											<li class="">
												<a href="{{ route("project.index") }}" class="waves-effect waves-dark">
													<span class="pcoded-mtext">Manage Project Info</span>
												</a>
											</li>
											<li class="">
												<a href="{{ route("activityPage") }}" class="waves-effect waves-dark">
													<span class="pcoded-mtext">Master schedule</span>
												</a>
											</li>
											<li class="">
												<a href="{{ route("scheduleActivityForProject") }}" class="waves-effect waves-dark">
													<span class="pcoded-mtext">Schedule Activity for Project</span>
												</a>
											</li>
