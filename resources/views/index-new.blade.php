        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse justify-content-center" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item"><a class="nav-link" href="{{ route('project.create') }}">Study Management</a>
                    </li>
                    <li class="nav-item"><a class="nav-link" href="#">Dashboard</a></li>
                    <li class="nav-item"><a class="nav-link" href="{{ route('qaDashboard') }}">Quality Assurance</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('masterSchedule') }}">
                            <span class="nav-link">Master schedule</span>
                        </a>
                    </li>
                ...
                @auth
                    ...
                    <div class="dropdown">
                        <a class="d-flex align-items-center text-white text-decoration-none dropdown-toggle" href="#"
                            ...
                            <i class="bi bi-person-circle fs-4 me-2"></i> Welcome,
