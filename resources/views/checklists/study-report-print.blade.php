...
<head>
    ...
    <title>Study Report Inspection Checklist — {{ $inspection->inspection_name ?? $inspection->type_inspection }}</title>
    <style>
...
<div class="document">
    ...
    <div class="doc-ref-strip">
        <div class="ref-item">
            ...
            <span class="ref-val">Study Report Inspection Checklist</span>
        </div>
        <div class="ref-item">
            <span class="ref-label">Réf. :</span>
            <span class="ref-val">QA-PR-1-005/06</span>
        </div>
        <div class="ref-item">
    ...
    <table class="info-table">
        <tr>
            ...
            <td>{{ $inspection->inspection_name ?? 'Study Report Inspection' }}</td>
