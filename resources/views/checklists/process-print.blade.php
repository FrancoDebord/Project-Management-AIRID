...
<head>
    ...
    <title>Process Inspection Checklist — {{ $inspection->inspection_name ?? $inspection->type_inspection }}</title>
    <style>
...
<div class="document">
    ...
    <div class="doc-ref-strip">
        <div class="ref-item">
            ...
            <span class="ref-val">Process Inspection Checklist</span>
        </div>
        <div class="ref-item">
            <span class="ref-label">Réf. :</span>
            <span class="ref-val">QA-PR-1-008/05</span>
        </div>
        <div class="ref-item">
    ...
    @php
        $processQaManager = $keyPersonnels['quality_assurance'] ?? null;
        $processInspector = $inspection->inspector ?? null;
        $inspectorIsManager = $processInspector && $processQaManager && $processInspector->id === $processQaManager->id;
    @endphp
    {{-- ── Inspection info table ── --}}
    <table class="info-table">
        <tr>
            <td class="label-col">Nom de l'inspection</td>
            <td>{{ $inspection->inspection_name ?? 'Process Inspection' }}</td>
        ...
        <tr>
            ...
            <td>{{ $processInspector ? $processInspector->prenom . ' ' . $processInspector->nom : '——' }}</td>
        ...
        <tr>
            ...
            <td colspan="3">{{ $processQaManager->prenom }} {{ $processQaManager->nom }}</td>
        </tr>
        @endif
    </table>
        ...
        <table>
            <tr>
                ...
                <td>
                    ...
                    <div style="font-size:9pt;">{{ $processInspector ? $processInspector->prenom . ' ' . $processInspector->nom : '' }}</div>
